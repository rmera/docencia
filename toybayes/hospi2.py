...
parser.add_argument("RU", type=int, default=3000, help="Upper limit for real cases")

parser.add_argument("-s", "--serious", type=float,default=0.003, help="True probability of serious cases. Default taken from s. Korea.")

parser.add_argument("-l", "--hlow", type=float,default=4.5, help="Lower limit for the hospitaized people in the country")

parser.add_argument("-u", "--hupp", type=float,default=5.5, help="Upper limit for the hospitaized people in the country")
