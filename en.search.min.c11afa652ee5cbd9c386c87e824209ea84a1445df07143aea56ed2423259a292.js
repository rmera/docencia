...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docencia/flexsearch.min.js');loadScript('/docencia/en.search-data.min.7d2a1df2e90a77128a31edcf203f73a30deb9dacf0b455c09a29a3a601cab66e.js',function(){input.required=false;search();});}
